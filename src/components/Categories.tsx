    ...
    const mockApiResponse = {
      ...
      data: [
        ...
        },
        {
          ...
          title: "Ro Purifiers",
          description:
            "Wall-mount RO purifiers save counter space, offering a sleek design and easy access. Under-counter RO purifiers, hidden beneath the sink, provide purified water via a separate faucet, preserving kitchen aesthetics. Zero water wastage RO purifiers use advanced technology to minimize water waste, making them eco-friendly and cost-effective. Each type caters to specific needs, ensuring clean water in any setting.",
          photos: [
            {
              id: "categories/prlk8hg3xgpjmiabfyjc",
              secure_url:
                "https://res.cloudinary.com/aquakartproducts/image/upload/v1723042021/categories/prlk8hg3xgpjmiabfyjc.png",
        ...
        },
        {
          ...
          description:
            "Discover Aquakart's premium softener and sand filter combos in Hyderabad. Perfect for homes and businesses, these systems remove hardness, impurities, and sediment, ensuring clean, soft water. Protect your appliances, plumbing, and skin with our efficient, eco-friendly water treatment solutions.",
          photos: [
            {
              id: "categories/s9aq4ytwsp4uxjgjl8io",
              secure_url:
                "https://res.cloudinary.com/aquakartproducts/image/upload/v1735742349/categories/s9aq4ytwsp4uxjgjl8io.jpg",
              _id: "6775538e38ae33212b161e59",
            },
          ],
          keywords:
            "Aquakart softener and sand filter combo near me in Hyderabad,\nBest Aquakart softener and sand filter in Hyderabad,\nAffordable Aquakart softener and sand filter in Hyderabad,",
          createdAt: "2025-01-01T14:39:10.176Z",
          updatedAt: "2025-01-18T08:02:07.970Z",
        },
      ],
    };
    categoryOperations.getCatgories().then((res) => {
